<?php
// This file is used to send all information from .env to the $_ENV superglobal associative array

/*----------------------------------------------------------------------------------------------*/
// Identifying .env file
...
// This code checks if the .env file is writable, but that is not necessary in this context
...
/*----------------------------------------------------------------------------------------------*/
// Storing info in $_ENV

foreach($var_arrs as $name => $value) { $_ENV[$name] = $value; }
